...
const usuariosPost = async (req, res = response) => {
    const { name, role, email, password, personalId, status, seccionesAsignadas } = req.body;
    const usuario = new Usuario({ name, thumb: '', role, email, password, personalId, status, seccionesAsignadas });
